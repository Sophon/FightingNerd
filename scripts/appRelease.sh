...
echo -e "${YELLOW}     - Builds signed AAB + APK (Android)${NC}"
echo -e "${YELLOW}     - Builds signed IPA (iOS)${NC}"
...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}GitHub Actions will now build and upload to Play Store and App Store Connect.${NC}"
