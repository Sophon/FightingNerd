...
internal fun SelectAllT8.toDomain(): Move {
    return Move(
        ...
        active = active?.stripMarkdownLinks(),
        cancel = cancel?.stripMarkdownLinks(),
        recovery = recovery?.stripMarkdownLinks(),
        guard = guard?.stripMarkdownLinks(),
        invulnerability = invulnerability?.stripMarkdownLinks(),
        isThrow = isThrow,
        notes = notes.toDomain(),
        aliases = aliases.toDomain(),
        urls = Move.Urls(
